    ...
    <body>
        <div class="d-flex">
            <div class="col-lg-5 parte01">
                <div class="card">
                    <form action="ControladorAlquiler?menu=NuevaVenta" method="POST">
                        <div class="card-body">
                            <!--DATOS DEL PRODUCTO-->
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="codigocliente" value="${c.getIdCli()}" class="form-control" placeholder="Codigo">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="codigoproducto" value="${producto.getIdmaq()}" class="form-control" placeholder="Codigo">
                                    <button type="submit" name="accion" value="BuscarProducto" class="btn btn-outline-info">Buscar</button>
                                </div>                           
                                <div class="col-sm-6">
                                    <input type="text" name="nomproducto" value="${producto.getNomModelo()}" placeholder="Datos Producto" class="form-control">
                                </div>  
                            </div>
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" value="1" name="cant" placeholder="" class="form-control">
                                </div>  
                                <div class="col-sm-3">
                                ...
                                <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="feini" value="" class="form-control" placeholder="0/0/0">                                
                                </div>                           
                                <div class="col-sm-6 d-flex">
                                    <input type="text" value="" name="fefin" placeholder="0/0/0" class="form-control">
                                </div>  
                ...
                <div class="card parte02">                    
                    <div class="card-body">
                        <div class="d-flex ml-auto col-sm-6">
                            ...
                            <input type="text" name="numeroserie" class="form-control text-center" value="${nserie}" style="font-weight: bold;font-size: 18px">
                        </div>                      
                        <br>
                            ...
                            <tbody>
                                <c:forEach var="list" items="${lista}">
                                    <tr class="text-center">
                                        ...
                                        <td>${list.getFechaini()}</td>
                                        <td>${list.getFechafin()}</td>
                    ...
                    <div class="card-footer" >
                        <div class="row">
                            <div class="col-sm-6">
                                <a href="ControladorAlquiler?menu=NuevaVenta&accion=GenerarVenta" onclick="print()" class="btn btn-success">Generar Venta</a>
